          ...
          <div class="row header-filter-table">
            ...
            <div class="col-sm-12 col-md-10 d-flex filter-control">
              <div class="btn-filter date-picker">
                <form action="{{ route('report-sale') }}" method="GET" class="d-flex" id="filterForm">
              ...
              <div class="btn-filter btn-export">
                <a href="{{route('export-sale')}}" class="btn btn-primary btn-sm">Export</a>
              </div>
          ...
          <table class="table">
            ...
            <tbody>
                ...
                <tr class="bg-total">
                  ...
                  <td>${{number_format($order_items->sum('price') * $order_items->sum('quantity'), 2)}}</td>
                </tr>
            </tbody>
            <tfoot>
              <tr>
                <td colspan="10" class="pagination-table">
                  {{$order_items->onEachSide(1)->links()}}
                </td>
              </tr>
            </tfoot>
          </table>
