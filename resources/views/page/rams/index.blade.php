...
<div class="container-xxl flex-grow-1 container-p-y">
   ...
   <div class="card">
        <div class="header-table-list">
            ...
            <a href="{{ route('insert-ram') }}" type="button" class="btn btn-success">Add New</a>
        </div>
        <div class="table-responsive text-nowrap">
          <div class="row header-filter-table">
            ...
            <div class="col-sm-12 col-md-10 d-flex filter-control">
              <form action="{{ route('ram') }}" method="GET" class="d-flex">
                @csrf
                <input 
                type="search" 
                name="search" 
                    ...
                    <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{route('update-ram', $ram->id)}}"><i class="bx bx-edit-alt me-2"></i> Edit</a>
                              <a class="dropdown-item" href="{{route('delete-ram', $ram->id)}}" onclick="return confirmation(event)"><i class="bx bx-trash me-2"></i> Delete</a>
                            </div>
                          </div>
                        </td>
                </tr>
