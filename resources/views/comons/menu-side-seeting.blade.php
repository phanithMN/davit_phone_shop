<ul class="list-unstyled">
    ...
    <a href="{{route('my-order')}}">
        <div class="sidebar-item">
            <svg class="mr-2" id="Group_24017" data-name="Group 24017" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22">
            <g id="Group_24016" data-name="Group 24016">
                <circle id="Ellipse_561" data-name="Ellipse 561" cx="0.47" cy="0.47" r="0.47" transform="translate(6.646 16.372)" fill="#b0b8c3"></circle>
                <circle id="Ellipse_562" data-name="Ellipse 562" cx="0.47" cy="0.47" r="0.47" transform="translate(14.357 16.372)" fill="#b0b8c3"></circle>
                <path id="Path_4481" data-name="Path 4481" d="M11,0A11,11,0,1,0,22,11,11,11,0,0,0,11,0ZM8,15.231h6.833a1.612,1.612,0,1,1-1.541,1.141H8.658A1.611,1.611,0,1,1,6.84,15.257L6.557,13.7l0-.015-1.5-7.434-1.38.009L3.664,5.116,5.985,5.1l.561,2.778,10.4,1.247-1.321,5.035H7.8Z" transform="translate(-0.002)"></path>
            </g>
            </svg> My Order
        </div>
    </a>
    ...
    <li class="border-bottom justify-content-center px-4 py-3 hover-menu {{ Route::currentRouteName() == 'coupon' ? 'active-menu' : '' }}">
        <a href="{{route('coupon')}}">
        <div class="sidebar-item">
            <!-- <i class="icons.my-copon mr-2"></i>    -->
            <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22">
            <path id="Subtraction_18" data-name="Subtraction 18" d="M11,22A11,11,0,0,1,3.222,3.222,11,11,0,1,1,18.778,18.778,10.928,10.928,0,0,1,11,22ZM6.483,15.457a.174.174,0,0,1,.16.16v.4h10.64a.8.8,0,0,0,.8-.8V6.784a.8.8,0,0,0-.8-.8H6.643v.4a.161.161,0,1,1-.321,0v-.4H4.716a.8.8,0,0,0-.8.8V9.354a.4.4,0,0,0,.4.4,1.225,1.225,0,0,1,0,2.449.4.4,0,0,0-.4.4v2.61a.8.8,0,0,0,.8.8H6.322v-.4A.174.174,0,0,1,6.483,15.457Zm0-.482a.174.174,0,0,1-.161-.16v-.843a.161.161,0,0,1,.321,0v.843A.174.174,0,0,1,6.483,14.974Zm7.267-.883a1.566,1.566,0,0,1,0-3.132,1.566,1.566,0,1,1,0,3.132Zm-.033-2.157a.618.618,0,0,0-.6.6.6.6,0,1,0,1.2,0A.618.618,0,0,0,13.716,11.934ZM9.574,13.449a.693.693,0,0,1-.253-.056l-.068-.024a.329.329,0,0,1-.161-.4c0-.04.038-.078.078-.118l4.82-4.258a.547.547,0,0,1,.351-.126.742.742,0,0,1,.331.085.278.278,0,0,1,.121.4c0,.039-.036.076-.075.116l0,.005L9.935,13.328A.556.556,0,0,1,9.574,13.449Zm-3.091-.16a.174.174,0,0,1-.161-.161v-.843a.161.161,0,0,1,.321,0v.843A.174.174,0,0,1,6.483,13.289Zm0-1.687a.174.174,0,0,1-.161-.16V10.6a.161.161,0,0,1,.321,0v.843A.174.174,0,0,1,6.483,11.6Zm3.292-.522A1.567,1.567,0,0,1,8.209,9.515a1.566,1.566,0,1,1,3.132,0A1.567,1.567,0,0,1,9.775,11.08Zm-.033-2.2a.6.6,0,1,0,.6.6A.6.6,0,0,0,9.742,8.883ZM6.483,9.916a.174.174,0,0,1-.161-.161V8.912a.161.161,0,0,1,.321,0v.843A.174.174,0,0,1,6.483,9.916Zm0-1.687a.174.174,0,0,1-.161-.16V7.226a.161.161,0,1,1,.321,0v.843A.174.174,0,0,1,6.483,8.23Z"></path>
            </svg> My Coupon
        </div>
        </a>
    </li>
